...
public:
    ...
    void loadExperiment(char *filename);
    string executeGame(tAgent* swarmAgent, tAgent* predatorAgent, FILE *data_file, bool report, double safetyDist, double predatorVisionAngle, int killDelay, double confusionMultiplier, double Es, double Emax, double Emin);
    tGame();
    ~tGame();
